    ...
    return (
      <div className="space-y-8">
        <section className="surface p-8">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight text-white">Edit course</h1>
          <p className="mt-4 max-w-3xl text-slate-300">Update your course details below. Lessons are managed separately.</p>
        </section>
